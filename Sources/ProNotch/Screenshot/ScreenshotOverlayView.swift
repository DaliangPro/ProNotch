        ...
        Task {
            ...
            if useSystem {
                do {
                    ...
                    await MainActor.run {
                        let img = TranslationRenderer.renderFragments(base: cropped, size: outSize, blocks: blocks,
                ...
                let trans = try await ScreenshotTranslator.translate(
                    ...
                    onPartial: { [weak self] range, chunk, done, total in
                        ...
                        Task { @MainActor in
                            ...
                            self.translatedOverride = TranslationRenderer.renderFragments(base: cropped, size: outSize, blocks: blocks,
